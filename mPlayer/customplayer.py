...
class mPlayer:
  ...
  def __init__(self): 
    ...
    self.queue = ["/Users/admin/Music/iTunes/iTunes Media/Music/Adrian Marcel/Unknown Album/2AM.mp3","/Users/admin/Music/iTunes/iTunes Media/Music/Penn Masala/Unknown Album/_Down.mp3"]
...
if __name__ == "__main__":
  ...
  if file_name == "":
    file_name = 'songs/testSongs/Bed Of Roses.mp3'
